...
for i in range(jumlah_bahan_baku):
    ...
    jumlah_bahan_baku_per_produk = st.number_input(f"Masukkan jumlah bahan baku {i+1} per produk: ")
    harga_bahan_baku = st.number_input(f"Masukkan harga bahan baku {i+1} per satuan: ")
